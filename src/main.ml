...
ApplicationWindow {
    ...
    menuBar: MenuBar {
        ...
        Menu {
            ...
            MenuItem {
                text: "Enable &Volumetric Accretion Disk"
                checkable: true; checked: false
                onToggled: {
                    if (viewportItem) viewportItem.volumetricDiskEnabled = checked
                }
            }
        }
        Menu {
    ...
    header: ToolBar {
        RowLayout {
            ...
            // Volumetric Accretion Disk controls (3D emissive flow around BH)
            ToolButton {
                text: "VDisk"
                checkable: true
                checked: viewportItem ? viewportItem.volumetricDiskEnabled : false
                onClicked: if (viewportItem) viewportItem.volumetricDiskEnabled = checked
                ToolTip.text: "Toggle volumetric accretion disk rendering"
            }
            Label {
                text: "VDensity:"
                font.pixelSize: 11
                color: "#aaa"
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
            }
            Slider {
                id: vDiskDensitySlider
                from: 0.0; to: 5.0; stepSize: 0.05
                value: 1.0
                Layout.preferredWidth: 90
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
                onValueChanged: if (viewportItem) viewportItem.volumetricDiskDensity = value
                ToolTip.text: "Volumetric disk density (r^-3/2 core)"
            }
            Label {
                text: vDiskDensitySlider.value.toFixed(2)
                font.pixelSize: 10
                color: "#aaa"
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
            }
            ...
            Slider {
                ...
                Layout.preferredWidth: 90
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
                onValueChanged: if (viewportItem) viewportItem.volumetricDiskTemperature = value
                ToolTip.text: "Volumetric disk temperature (r^-3/4)"
            }
            Label {
                text: vDiskTempSlider.value.toFixed(2)
                font.pixelSize: 10
                color: "#aaa"
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
            }
            ...
            Slider {
                ...
                Layout.preferredWidth: 90
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
                onValueChanged: if (viewportItem) viewportItem.volumetricDiskScaleHeight = value
                ToolTip.text: "Volumetric disk Gaussian scale height"
            }
            Label {
                text: vDiskHtSlider.value.toFixed(2)
                font.pixelSize: 10
                color: "#aaa"
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
            }
            ...
            Slider {
                ...
                Layout.preferredWidth: 90
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
                onValueChanged: if (viewportItem) viewportItem.volumetricDiskOpacity = value
                ToolTip.text: "Volumetric disk opacity"
            }
            Label {
                text: vDiskOpSlider.value.toFixed(2)
                font.pixelSize: 10
                color: "#aaa"
                visible: viewportItem ? viewportItem.volumetricDiskEnabled : false
            }
    ...
    SplitView {
        ...
        Pane {
            ...
            ScrollView {
                ...
                Pane {
                    Layout.fillWidth: true
                    visible: discoveryPanelManager && discoveryPanelManager.instrumentCount > 0
                    background: Rectangle {
                        color: "#1a1a2e"
                        radius: 6
                        border.color: "#2a2a4a"
                    ...
                    DiscoveryDashboard {
                        manager: discoveryPanelManager
                        onParametersChanged: console.log("Discovery parameters updated")
                    }
                }

...
**Next immediate action:** Begin Phase 0 GUI-first modifications—implement main viewport with 4D camera controls, bottom timeline bar, and context menu system before proceeding to deep physics integration.
...
void test_adjoint_geodesic_basic() {
    ...
    QV_CHECK(result.steps > 0);
    QV_CHECK(std::isfinite(result.finalState[1]));
    QV_CHECK(result.finalState[1] > 0.0);
    QV_CHECK(result.finalState[1] < 10.0);
